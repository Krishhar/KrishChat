...
const accessController = asyncHandler(async (req, res) => {
    ...
    var isChat = await Chat.find({
        isGroupChat: false,
        $and: [
            { users: { $elemMatch: { $eq: req.user._id } } }, // Changed req.users._id to req.user._id
...
module.exports = {
    accessController, fetchChats, createGroupChats, renameGroup, addToGroup, removeFromGroup, }